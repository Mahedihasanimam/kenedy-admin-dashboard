...
const ConfessionApproval = () => {
  ...
  const { data: confessionData, isLoading } = useGetAllConfessionsQuery({
    status: statusFilter, // Filter by selected status
    page: currentPage,
    limit: commentsPerPage,
  });

  const [approvedConfession, approvedResults] = useApproveConfessionMutation();
  const [cancelConfession, cancelResults] = useCancelConfessionMutation();
  ...
  const handleApprove = async (id) => {
    try {
      ...
      Swal.fire({
        icon: "success",
        title: "Confession Approved Successfully!",
